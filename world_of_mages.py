...
def start():
    new = open("character.txt", "r")
    if os.stat("character.txt").st_size==0:
        print("#####################################")
        czy=open("czy.txt","w")
        czy.write(str(1))
        czy.close()
